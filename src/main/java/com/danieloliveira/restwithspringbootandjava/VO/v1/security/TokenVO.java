package com.danieloliveira.restwithspringbootandjava.VO.v1.security;
...
public class TokenVO implements Serializable {
    ...
    private String accessToken; // armazena efetivamente o token
    private String refreshToken; // usado para renovar o token
